...
| Interfaccia Utente | Pagina web statica servita same-origin da FastAPI; essere vivente 3D come baricentro, chat testo/voce in streaming via canale unico `/ws/session`, log azioni dal vivo, gate di conferma, barra↔cronologia unificata, schede grafiche flottanti. Design ripreso dall'export v1 come stella polare. Costruzione a fasi 7.1–7.6 (ROADMAP.md); composizione dell'interfaccia finita in `notes/interfaccia-prodotto-finito.md`. **Fatto (7.1–7.2)**: login + turno di testo in streaming su `/ws/session` (translator condiviso con la Voce) + essere reattivo; log azioni dal vivo (`tool_in_corso`/`tool_finito`), gate di conferma visivo (scheda formato mail, descrizione dal server come fonte unica CLI+web, TTL 1h), spia connessione con auto-riconnessione; 7.3–7.6 rimandate | in costruzione (7.1–7.2 fatte, 7.3 prossima) | [docs/interfaccia_utente/README.md](docs/interfaccia_utente/README.md) |
